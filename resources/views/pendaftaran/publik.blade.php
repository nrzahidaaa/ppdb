...
<div style="background:#fff;border-radius:16px;box-shadow:0 10px 25px rgba(0,0,0,0.08);overflow:hidden;">
    ...
    <div style="background:linear-gradient(135deg,#33528A,#33A9A0);padding:24px 28px;color:#fff;text-align:center;">
        ...
        <p style="margin:4px 0 0;font-size:12px;opacity:.85;">Tahun 2026 — Isi data dengan lengkap dan benar</p>
    </div>
    ...
    <div style="padding:28px;">
        ...
        <form method="POST" action="{{ route('pendaftaran.storePublik') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama" class="form-control" value="{{ old('nama') }}" required placeholder="Nama lengkap sesuai akta">
            </div>
            ...
            <div class="form-group">
                ...
                <div style="display:flex;flex-wrap:wrap;gap:12px;margin-top:6px;">
                    ...
                    <label style="display:flex;align-items:center;gap:6px;font-size:12px;cursor:pointer;">
                        <input type="radio" name="hobi" value="{{ $h }}" {{ old('hobi')==$h?'checked':'' }}> {{ $h }}
                    </label>
                    @endforeach
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div style="display:flex;flex-wrap:wrap;gap:12px;margin-top:6px;">
                    ...
                    <label style="display:flex;align-items:center;gap:6px;font-size:12px;cursor:pointer;">
                        <input type="radio" name="cita_cita" value="{{ $c }}" {{ old('cita_cita')==$c?'checked':'' }}> {{ $c }}
                    </label>
                    @endforeach
                </div>
            </div>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
                <div class="form-group">
                    ...
                    <input type="number" name="anak_ke" class="form-control" value="{{ old('anak_ke') }}" min="1" placeholder="contoh: 1">
                </div>
                <div class="form-group">
                    <label class="form-label">Jumlah Saudara</label>
                    <input type="number" name="jumlah_saudara" class="form-control" value="{{ old('jumlah_saudara') }}" min="0" placeholder="contoh: 2">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div style="display:flex;flex-wrap:wrap;gap:10px;margin-top:6px;margin-bottom:10px;">
                    ...
                    <label style="display:flex;align-items:center;gap:6px;font-size:12px;cursor:pointer;">
                        <input type="radio" name="status_tinggal" value="{{ $st }}" {{ old('status_tinggal')==$st?'checked':'' }}> {{ $st }}
                    </label>
                    @endforeach
                </div>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="kode_pos" class="form-control" value="{{ old('kode_pos') }}" placeholder="contoh: 70700">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="asal_sekolah" class="form-control" value="{{ old('asal_sekolah') }}" required placeholder="Nama SD/MI asal">
            </div>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:12px;">
                <div class="form-group">
                    ...
                    <div style="display:flex;gap:12px;margin-top:6px;">
                        @foreach(['SD','MI'] as $js)
                        <label style="display:flex;align-items:center;gap:6px;font-size:12px;cursor:pointer;">
                            <input type="radio" name="jenis_sekolah" value="{{ $js }}" {{ old('jenis_sekolah')==$js?'checked':'' }}> {{ $js }}
                        </label>
                        @endforeach
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div style="display:flex;gap:12px;margin-top:6px;">
                        ...
                        <label style="display:flex;align-items:center;gap:6px;font-size:12px;cursor:pointer;">
                            <input type="radio" name="status_sekolah" value="{{ $ss }}" {{ old('status_sekolah')==$ss?'checked':'' }}> {{ $ss }}
                        </label>
                        @endforeach
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" name="npsn_sekolah" class="form-control" value="{{ old('npsn_sekolah') }}" placeholder="8 digit">
                </div>
            </div>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
                <div class="form-group">
                    ...
                    <input type="text" name="no_kk" class="form-control" value="{{ old('no_kk') }}" placeholder="16 digit">
                </div>
                <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div style="display:flex;flex-wrap:wrap;gap:12px;margin-top:6px;">
                    ...
                    <label style="display:flex;align-items:center;gap:6px;font-size:12px;cursor:pointer;">
                        <input type="radio" name="status_kepemilikan_rumah" value="{{ $sr }}" {{ old('status_kepemilikan_rumah')==$sr?'checked':'' }}> {{ $sr }}
                    </label>
                    @endforeach
                </div>
            </div>
            ...
            <div style="background:#f8f9fc;border-radius:10px;padding:16px;margin-bottom:16px;">
                ...
                <div class="form-group">
                    ...
                    <div style="display:flex;gap:16px;margin-top:6px;">
                        ...
                        <label style="display:flex;align-items:center;gap:6px;font-size:12px;cursor:pointer;">
                            <input type="radio" name="status_ayah" value="{{ $sa }}" {{ old('status_ayah')==$sa?'checked':'' }}> {{ $sa }}
                        </label>
                        @endforeach
                    </div>
                </div>
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
                    <div class="form-group">
                        ...
                        <select name="pendidikan_ayah" class="form-control">
                            ...
                            <option value="{{ $pd }}" {{ old('pendidikan_ayah')==$pd?'selected':'' }}>{{ $pd }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="penghasilan_ayah" class="form-control">
                            ...
                            <option value="{{ $pg }}" {{ old('penghasilan_ayah')==$pg?'selected':'' }}>{{ $pg }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        <label class="form-label">No. HP Ayah</label>
                        <input type="text" name="no_hp_ayah" class="form-control" value="{{ old('no_hp_ayah') }}" placeholder="08xxxxxxxxxx">
                    </div>
                </div>
            </div>
            ...
            <div style="background:#f8f9fc;border-radius:10px;padding:16px;margin-bottom:16px;">
                ...
                <div class="form-group">
                    ...
                    <div style="display:flex;gap:16px;margin-top:6px;">
                        ...
                        <label style="display:flex;align-items:center;gap:6px;font-size:12px;cursor:pointer;">
                            <input type="radio" name="status_ibu" value="{{ $si }}" {{ old('status_ibu')==$si?'checked':'' }}> {{ $si }}
                        </label>
                        @endforeach
                    </div>
                </div>
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
                    <div class="form-group">
                        ...
                        <select name="pendidikan_ibu" class="form-control">
                            <option value="">-- Pilih --</option>
                            @foreach(['SD/Sederajat','SMP/Sederajat','SMA/Sederajat','D1','D2','D3','D4/S1','S2','S3','Tidak Bersekolah','Lainnya'] as $pd)
                            <option value="{{ $pd }}" {{ old('pendidikan_ibu')==$pd?'selected':'' }}>{{ $pd }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="penghasilan_ibu" class="form-control">
                            <option value="">-- Pilih --</option>
                            @foreach(['dibawah 800.000','800.000 - 1.200.000','1.200.000 - 1.800.000','1.800.000 - 2.500.000','2.500.000 - 3.500.000','3.500.000 - 4.800.000','4.800.000 - 6.500.000','6.500.000 - 10.000.000','10.000.000 - 20.000.000','diatas 20.000.000'] as $pg)
                            <option value="{{ $pg }}" {{ old('penghasilan_ibu')==$pg?'selected':'' }}>{{ $pg }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        <label class="form-label">No. HP Ibu</label>
                        <input type="text" name="no_hp_ibu" class="form-control" value="{{ old('no_hp_ibu') }}" placeholder="08xxxxxxxxxx">
                    </div>
                </div>
            </div>
            ...
            <div style="margin-bottom:16px;">
                <label style="display:flex;align-items:center;gap:8px;cursor:pointer;font-size:13px;font-weight:600;">
                    <input type="checkbox" id="toggle-wali" onchange="document.getElementById('section-wali').style.display=this.checked?'block':'none'">
                    Tambah Data Wali (jika tinggal dengan family atau keluarga lain)
                </label>
            </div>

            <div id="section-wali" style="display:none;background:#f8f9fc;border-radius:10px;padding:16px;margin-bottom:16px;">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nik_wali" class="form-control" value="{{ old('nik_wali') }}">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div style="display:flex;gap:12px;flex-wrap:wrap;margin-top:6px;">
                        ...
                        <label style="display:flex;align-items:center;gap:6px;font-size:12px;cursor:pointer;">
                            <input type="radio" name="status_wali" value="{{ $sw }}" {{ old('status_wali')==$sw?'checked':'' }}> {{ $sw }}
                        </label>
                        @endforeach
                    </div>
                </div>
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
                    <div class="form-group">
                        ...
                        <select name="pendidikan_wali" class="form-control">
                            <option value="">-- Pilih --</option>
                            @foreach(['SD/Sederajat','SMP/Sederajat','SMA/Sederajat','D1','D2','D3','D4/S1','S2','S3','Tidak Bersekolah','Lainnya'] as $pd)
                            <option value="{{ $pd }}" {{ old('pendidikan_wali')==$pd?'selected':'' }}>{{ $pd }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select name="pekerjaan_wali" class="form-control">
                            <option value="">-- Pilih --</option>
                            @foreach(['Tidak Bekerja','Pensiunan','PNS','TNI/Polri','Guru/Dosen','Pegawai Swasta','Wiraswasta','Pencagara/Hakim','Seniman','Dokter/Bidan/Perawat','Pilot/Pramugara','Pedagang','Petani/Peternak','Nelayan','Buruh','Sopir/Masinis/Kondektur','Politikus','Lainnya'] as $pk)
                            <option value="{{ $pk }}" {{ old('pekerjaan_wali')==$pk?'selected':'' }}>{{ $pk }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select name="penghasilan_wali" class="form-control">
                            <option value="">-- Pilih --</option>
                            @foreach(['dibawah 800.000','800.000 - 1.200.000','1.200.000 - 1.800.000','1.800.000 - 2.500.000','2.500.000 - 3.500.000','3.500.000 - 4.800.000','4.800.000 - 6.500.000','6.500.000 - 10.000.000','10.000.000 - 20.000.000','diatas 20.000.000'] as $pg)
                            <option value="{{ $pg }}" {{ old('penghasilan_wali')==$pg?'selected':'' }}>{{ $pg }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        <label class="form-label">No. HP Wali</label>
                        <input type="text" name="no_hp_wali" class="form-control" value="{{ old('no_hp_wali') }}" placeholder="08xxxxxxxxxx">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div style="display:flex;gap:20px;margin-top:6px;">
                    <label style="display:flex;align-items:center;gap:6px;font-size:13px;cursor:pointer;">
                        <input type="radio" name="jalur" value="reguler" {{ old('jalur')=='reguler'?'checked':'' }} required> 📋 Reguler
                    </label>
                    <label style="display:flex;align-items:center;gap:6px;font-size:13px;cursor:pointer;">
                        <input type="radio" name="jalur" value="prestasi" {{ old('jalur')=='prestasi'?'checked':'' }}> 🏆 Prestasi
                    </label>
                </div>
            </div>

            {{-- ===== NAMA ORANG TUA (Bin/Binti) ===== --}}
            <div class="form-group">
                <label class="form-label">Bin/Binti (Nama Orang Tua) <span style="color:#e05454">*</span></label>
                <input type="text" name="nama_orang_tua" class="form-control" value="{{ old('nama_orang_tua') }}" placeholder="contoh: bin Ahmad / binti Siti" required>
            </div>
...
var namaWaliLama = "{{ old('nama_wali') }}";
if (namaWaliLama) {
    document.getElementById('toggle-wali').checked = true;
    document.getElementById('section-wali').style.display = 'block';
}
</script>
