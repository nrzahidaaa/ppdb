...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/pendaftaran/template', [PendaftaranController::class, 'template'])
        ->name('pendaftaran.template');
    ...
    Route::get('/nilai-tes/template', [NilaiTesController::class, 'downloadTemplate'])->name('nilai-tes.template');

    Route::get('/tahun-ajaran', [TahunAjaranController::class, 'index'])->name('tahun-ajaran.index');
    Route::post('/tahun-ajaran', [TahunAjaranController::class, 'store'])->name('tahun-ajaran.store');
    Route::put('/tahun-ajaran/{id}/toggle', [TahunAjaranController::class, 'toggle'])
    ->name('tahun-ajaran.toggle');
    Route::post('/tahun-ajaran/pilih', [TahunAjaranController::class, 'pilih'])->name('tahun-ajaran.pilih');

    Route::post('/admin/pendaftaran/{id}/minta-perbaikan', [App\Http\Controllers\PendaftaranController::class, 'mintaPerbaikan'])
    ->name('admin.pendaftaran.mintaPerbaikan');
});