...
<div class="card" style="margin-bottom:20px;">
    <div class="card-body" style="padding:24px;">
        ...
        <div style="margin-top:20px;padding:20px;background:#fff;border-radius:12px;">
            ...
            <form action="{{ route('admin.pendaftaran.mintaPerbaikan', $pendaftaran->id) }}" method="POST">
                @csrf
                <div style="margin-bottom:12px;">
                    <label for="catatan_admin">Catatan Admin</label>
                    <textarea name="catatan_admin" id="catatan_admin" rows="4" class="form-control" required>{{ old('catatan_admin', $pendaftaran->catatan_admin) }}</textarea>
                </div>
